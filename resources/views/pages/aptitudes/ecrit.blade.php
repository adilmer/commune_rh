...
<div class="row ">
    ...
    <div class="col-sm-2  ">
        <a href="{{route('aptitude.ecrit_saveAll',$aptitude->id_aptitude)}}" class="btn btn-info">إضافة كل المستدعين </a>
    </div>
</div>
        <div class="row">
          ...
          <div class="col-lg-12 d-flex align-items-stretch">
            <div class="card w-100">
              <div class="card-body p-4">
                <h5 class="card-title fw-semibold mb-4">لائحة الموظفين المقبولين لإجتياز الإمتحان الكتابي </h5>
                    ...
                    <tr>
                        ...
                        <td class="border-bottom-0">
                          <div class="d-flex align-items-center gap-2">
                            <a href="{{route('aptitude.ecrit_remove',$aptitude->id_liste_aptitude)}}">
            ...
            <div class="btnsimple text-start m-4 ">
                <button type="submit" class="btn btn-dark-light ">طباعة الإستدعاءات </button>
...
<div class="modal fade" id="exampleModal2" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <form action="{{route('aptitude.ecrit_save')}}" method="post">
        @csrf
    ...
    <input type="text" class="form-control" list="agents_list" id="list_agents"  autocomplete="off"  placeholder="تحديد المعني بالأمر" value="" required >
        ...
        <datalist id="agents_list" >
            @foreach ($aptitudes as $aptitude)
            <option data-id="{{$aptitude->id_agent}}" value="{{$aptitude->agent->nom_ar}}" >
            @endforeach
        </datalist>
    </div>
