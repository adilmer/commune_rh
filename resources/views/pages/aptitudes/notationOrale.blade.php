      ...
      <select name="id_grade" id="id_grade" class="custom-select custom-select-lg mb-3 form-control">
        ...
        <div class="row">
          ...
          <div class="col-lg-12 d-flex align-items-stretch">
            <form action="{{route('aptitude.notationOrale_save')}}" method="post">
            @csrf
            <div class="card w-100">
              <div class="card-body p-4">
                <h5 class="card-title fw-semibold mb-4"> لائحة المجتازين للإختبار الشفوي</h5>
                <div class="table-responsive">
                  <table class="table text-nowrap mb-0 align-middle">
                    <thead class="text-dark fs-4">
                      <tr>
                        ...
                        <th class="border-bottom-0">
                            <h6 class="fw-semibold mb-0">نقطة الإمتحان الشفوي</h6>
                          </th>
                      </tr>
                    </thead>
                  ...
                  <tr>
                      ...
                      <td class="border-bottom-0 ">
                                <input class="form-control" type="number" min="0" max="20" name="note_ecrit[]" value="{{$aptitude->note_ecrit ?? 0}}" disabled >
                        </td>
                      <td class="border-bottom-0 ">
                        <input type="hidden" name="id_liste_aptitude[]" value="{{$aptitude->id_liste_aptitude}}">
                        <input class="form-control" type="number" min="0" max="20" step="0.25" name="note_orale[]" value="{{$aptitude->note_orale ?? 0}}" >
                        </td>
                    </tr>
                  @endif
