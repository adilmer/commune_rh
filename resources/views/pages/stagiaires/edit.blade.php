...
<div class="card">
      <div class="card-body">
        <h5 class="card-title fw-semibold mb-4"> تعديل المتدرب </h5>
        <div class="card">
          <div class="card-body">
            <div class="row">
              ...
              <div class="col-6 mt-4">
                ...
                <input name="nom_stagiaire_fr" type="text" class="form-control" id="nom_stagiaire_fr" placeholder="">     
              </div>
              <div class="col-6 mt-4">
      ...
      <div class="btnsimple text-start m-4 ">
        <button class="btn btn-primary ">تعديل المعلومــات</button>
      </div>
    </div>
@endsection
