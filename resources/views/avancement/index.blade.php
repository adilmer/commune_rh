...
>>>>>>> 4b832d908687dbe878760366aeff3a264cb8dcb1
        ...
        <table style="direction: ltr" cellpadding="0" cellspacing="0" id="sheet0" class="sheet0 gridlines">
            ...
            <tbody>
              <tr class="row0">
                ...
                <td class="column13 style6 s">CIN :</td>
                <td class="column14 style7 s style7" colspan="6">{{$agent->cin}}</td>
                ...
                <td class="column27 style9 s style9" colspan="4">Numéro Somme :</td>
                <td class="column31 style10 n style11" colspan="4">{{$agent->ppr}}</td>
              </tr>
              <tr class="row1">
              ...
              <tr class="row16">
                ...
                <td class="column23 style91 s" colspan="3">Regularisation d'avancement </td>
                <td class="column24 style91 null">au</td>
                ...
                <td class="column31 style93 s">{{$Nagent->echellon}}°</td>
                <td class="column32 style93 s">echelon</td>
              ...
              <tr class="row23">
                ...
                <td class="column22 style124 f style124" colspan="4"></td>
                <td class="column26 style125 s">*</td>
                <td class="column27 style126 n style126" colspan="2">0</td>
              ...
              <tr class="row24">
                ...
                <td class="column26 style129 f style129" colspan="5"></td>
              ...
              <tr class="row25">
                ...
                <td class="column22 style131 null style131" colspan="6"></td>
                <td class="column28 style63 s style63" colspan="2">Au</td>
                <td class="column30 style131 f style132" colspan="5"></td>
              </tr>
              <tr class="row26">
              ...
              <tr class="row29">
                ...
                <td class="column20 style62 s style63" colspan="2">Du</td>
                <td class="column22 style131 f style63" colspan="6"></td>
                <td class="column28 style63 s style63" colspan="2">Au</td>
                <td class="column30 style131 f style132" colspan="5"></td>
              </tr>
              <tr class="row30">
